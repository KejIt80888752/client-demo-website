    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-6">
        <div className="space-y-4">
          ...
          <p className="text-lg max-w-lg" style={{ color: "#7a7a7a" }}>
        ...
        <Link to="/gallery">
          <Button
            ...
            style={{ borderColor: "rgba(220,30,30,0.3)", color: "#f87171", background: "transparent" }}
            onMouseEnter={e => {
      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
        {galleryImages.map((img, index) => (
          <div key={index} className="relative group overflow-hidden rounded-xl break-inside-avoid"
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              style={{ background: "linear-gradient(to top, rgba(220,30,30,0.75) 0%, rgba(220,30,30,0.1) 50%, transparent 100%)" }} />
            {/* Red border inset glow */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-xl"
              style={{ boxShadow: "inset 0 0 0 2px rgba(220,30,30,0.5)" }} />
            {/* Label */}
